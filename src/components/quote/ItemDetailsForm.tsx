...
export const ItemDetailsForm: React.FC<ItemDetailsFormProps> = ({ onNext }) => {
  ...
  const handlePhotoCapture = (photoBase64: string) => {
    ...
    updateCurrentItem({ photo: photoBase64 });
    toast({
      ...
      <Card className="w-full max-w-2xl mx-auto">
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              {photo ? (
                <Card className="p-4">
                  <div className="relative">
                    <img src={photo} alt="Item" className="w-full h-48 object-cover rounded" />
                    <Button
                      type="button"
            ...
            <div>
              <Label htmlFor="weight">Weight (DWT)</Label>
              <Input
                id="weight"
                type="number"
                step="0.01"
            ...
            <Button type="submit" className="w-full" disabled={pricingLoading}>
